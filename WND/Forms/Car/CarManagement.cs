...
namespace WND.Car
{
    public partial class EditCar : Form
    {
        ...
        private void EditCar_Load(object sender, EventArgs e)
        {
            ...
            if (TaxiDbContext.Instance.Cars.Any())
            {
                Drivers = TaxiDbContext.Instance.Users.OfType<Models.Driver>().Where(u => u.Role == Models.Roles.Driver).Select(u => u);
        ...
        private void comboboxDrivers_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            selectedDriver = TaxiDbContext.Instance.Users
        ...
        private void btnEditCar_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                {
                    //update car
                    TaxiDbContext.Instance.Cars.Attach(selectedDriver.Car);
        ...
        private void txtLicencePlate2_TextChanged(object sender, EventArgs e)
        {
