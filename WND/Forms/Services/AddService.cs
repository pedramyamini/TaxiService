...
namespace WND
{
    public partial class AddService : Form
    {
        ...
        public AddService(ITaxiDbContext _taxiContext)
        {
            InitializeComponent();
            taxiContext = _taxiContext;
        }

        public AddService(ITaxiDbContext _taxiContext, Form _sourceForm)
        {
            InitializeComponent();
            taxiContext = _taxiContext;
        ...
        private void btnAddService_Click(object sender, EventArgs e)
        {
            ...
            if(Validation.Validate(service))
            {
                try
                {
                    taxiContext.Services.Add(service);
        ...
        private void AddService_FormClosed(object sender, FormClosedEventArgs e)
        {
